...
function Checkout() {
  ...
  const summary = totals(deliveryMethod);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_380px]">
          <form onSubmit={submit} className="space-y-6">
            <section className="rounded-2xl border border-dark-100 bg-white p-5 shadow-soft sm:p-6">
              <h2 className="font-heading text-xl font-bold text-dark-950">
                Contact details
              </h2>

              <p className="mt-1 text-sm text-dark-500">
                Checkout as a guest. You can create an account later with this
                email.
              </p>
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                ...
                <label className="text-sm font-semibold text-dark-700">
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-xl border border-dark-200 bg-white px-4 py-3 font-normal outline-none focus:border-primary-500"
                  >
                    <option value="delivery">Home delivery</option>
                    <option value="pickup">Pickup at Resvill</option>
                  </select>
                </label>
              </div>
            ...
            <section className="rounded-2xl border border-dark-100 bg-white p-5 shadow-soft sm:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-dark-500">
                    Paystack will be connected here later. This test payment is
                    not charged.
                  </p>
                </div>
              </div>
              ...
              <button
                type="submit"
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-primary-500 px-5 py-3.5 font-bold text-white hover:bg-primary-600"
              >
                <CheckCircle2 size={18} />
                Pay {formatNaira(summary.total)} securely
              </button>
            </section>
          </form>
          ...
          <aside className="h-fit rounded-2xl border border-dark-100 bg-white p-5 shadow-soft sm:p-6">
            ...
            <div className="mt-5 space-y-3 border-t border-dark-100 pt-5 text-sm">
              ...
              <div className="flex justify-between border-t border-dark-100 pt-4 text-base font-extrabold">
                <span>Total</span>
                <span>{formatNaira(summary.total)}</span>
              </div>
            </div>

            <p className="mt-5 flex gap-2 text-xs leading-5 text-dark-500">
              <MapPin size={15} className="shrink-0 text-primary-500" />
              Your tracking link will be generated immediately after payment.
            </p>

            <Link
              to="/cart"
              className="mt-5 block text-center text-sm font-bold text-primary-500"
            >
              Return to cart
            </Link>
          </aside>
