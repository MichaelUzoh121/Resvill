...
import { ArrowLeft, ArrowRight, BadgeCheck, Eye, EyeOff, LockKeyhole, Sparkles, TriangleAlert } from "lucide-react";
...
function ResetPassword() {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      setServerError(error.message || "This reset link is invalid or has expired.");
      setStatus("error");
    }
  };
                ...
                <form onSubmit={submit} noValidate className="space-y-5">
                  <label className="block text-sm font-bold text-dark-700">
                    ...
                    <div className="relative mt-2">
                      <LockKeyhole size={19} className="absolute left-4 top-1/2 -translate-y-1/2 text-dark-400" />
                      <input
                        required
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-dark-400 hover:text-primary-500"
                      >
